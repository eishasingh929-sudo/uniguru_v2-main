...
## 1. Why UniGuru Is Becoming Usable Infrastructure
...
## 3. Why Knowledge Growth Must Preserve Lineage

Knowledge growth without lineage becomes unreplayable. UniGuru must be able to explain which source record shaped an answer, what version of the curriculum was used, what trust ceiling applied, and whether the record was verified or only a sample seed. Lineage is what keeps expansion from becoming silent mutation.

## 4. Replay-Safe Curriculum Cognition vs Ordinary RAG

Ordinary RAG usually retrieves chunks and generates an answer. Replay-safe curriculum cognition retrieves governed records, preserves metadata, evaluates trust and contradiction state, caps authority, emits a runtime hash, and stores an execution proof. The answer is not just text; it is a traceable constitutional event.
